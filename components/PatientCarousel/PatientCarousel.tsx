...
const patientSlides: PatientSlide[] = [
  ...
  },
  {
    ...
    desc: "Cartão de autocuidado (Giftcard) para presentear pessoas com tratamentos não médicos na clínica. Incentiva pacientes a voltarem e ajuda a atrair novos.",
    image: "/giftcard.png",
  },
  {
    title: "COMPARTILHE SAÚDE",
    desc: "Ao indicar uma pessoa para acompanhar as novidades e os conteúdos da clínica, a paciente pode ganhar benefícios em tratamentos não médicos.",
    image: "/indicacao.png",
  },
  {
    title: "CONTEÚDO BLOG",
